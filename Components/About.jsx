  ...
  return (
    ...
    >
      <div className="uk-container">
        <header className="uk-grid-xsmall uk-flex-center uk-flex-middle uk-grid">
          <div className="uk-panel uk-text-center">
            <h2 className="uk-h3 uk-h1@m">About the platform</h2>
          </div>
        </header>
        <div className="uk-panel uk-margin-medium-top uk-margin-2xlarge-top@m">
          <div className="uk-grid uk-grid-2xlarge uk-grid-3xlarge@m uk-child-width-1-1">
            <div>
                ...
                <div className="uk-grid uk-grid-3xlarge@m uk-flex-middle uk-child-width-1-2@m">
                  <div>
                    <div className="uk-panel uk-image-middle uk-overflow-hidden uk-radius uk-radius-large@m">
                      <img
                        src="../assets/images/BansheeTY.png"
                        alt="Create your own NFT"
                      />
                    </div>
                  </div>
                  <div>
                    <div className="uk-panel">
                      ...
                      <h3 className="uk-h3 uk-h1@m">Music Airdrops</h3>
                      <p className="uk-text-large@m">
                        Airdrop songs, albums, and tickets to fans.
                      </p>
                      <div className="uk-grid uk-grid-large@m uk-grid-match uk-child-width-1-2 uk-margin-large-top@m">
                        <div>
                          <div className="uk-panel">
                            <h5 className="uk-h4 uk-h2@m uk-margin-xsmall">
                              4,500+
                            </h5>
                            ...
                            <div className="uk-grid uk-grid-xsmall uk-grid-small@m">
                              <div>
                                <div className="uk-card uk-card-xsmall uk-radius-medium uk-radius-large@m uk-background-gradient uk-flex-middle uk-flex-center">
                                  <i className="uk-icon-small uk-icon-medium@m unicon-select-02 uk-text-white" />
                                </div>
                              </div>
                        ...
                        <div>
                          <div className="uk-panel">
                            <div className="uk-grid uk-grid-xsmall uk-grid-small@m">
                              <div>
                                <div className="uk-card uk-card-xsmall uk-radius-medium uk-radius-large@m uk-background-gradient uk-flex-middle uk-flex-center">
                                  <i className="uk-icon-small uk-icon-medium@m unicon-select-window uk-text-white" />
                                </div>
                              </div>
                              <div className="uk-width-expand">
                                <span className="uk-text-small@m">
